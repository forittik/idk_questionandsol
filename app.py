...
def main():
    ...
    try:
        # Initialize managers without exposing secrets
        github_manager = GithubManager()
        ai_analyzer = AIAnalyzer()
    except Exception as e:
        st.error("Error initializing services. Please check if all required secrets are configured.")
        st.info("Required secrets: github_token, github_repo, gemini_api_key, openai_api_key")
        return
